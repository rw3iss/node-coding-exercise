define(['jquery',
	...
	Home.prototype.getNews = function() {
		var _this = this;
		_this.animateBanner(.5);
		// $.ajax('/api/news', {
  //           success: function(response) {
  //               if ( response.title ) {
  //                   $('#banner #news-cta h2').html( response.title );
  //               }
  ...
  //       });
	...
	Home.prototype.updateGlobePos = function(tweenProgress) {
		TweenMax.set($('#globeWrapper'), { y : 41 * tweenProgress + '%'} );
